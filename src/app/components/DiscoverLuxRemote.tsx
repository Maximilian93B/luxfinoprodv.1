  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.button
          className="px-8 py-3 bg-luxocean/80 text-luxpearl rounded-full font-light text-lg hover:bg-luxcopper/80 transition-all duration-300 shadow-md hover:shadow-lg"
...
const DiscoverSection: React.FC = () => {
  return (
    <section id="discover" className="py-24 bg-luxsand/80 overflow-hidden">
      <div className="container mx-auto px-8 relative">
        <div className="absolute inset-0 bg-[url('/grain.png')] opacity-5" />
        <motion.h1 
          className="text-5xl md:text-5xl lg:text-6xl font-light text-center  mb-12 font-playfair text-luxcedar leading-tight"
